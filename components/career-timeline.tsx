...
const timelineData: CareerItem[] = [
  {
    ...
    type: "work",
    description:
      "Profissional com experiência superior a dois anos no campo da Tecnologia da Informação, trabalhando como Assistente de TI na PROGT Industrial. Com formação técnica em TI e atualização contínua, detenho conhecimentos robustos em assistência ao usuário, administração de infraestrutura de TI e envolvimento em projetos de software.",
    responsibilities: [
      "Assistência ao usuário e suporte técnico",
      ...
      "Comunicação e colaboração com equipes",
    ...
    achievements: [
      {
        ...
        description:
          "Contribuição para a evolução dos procedimentos e eficácia operacional.",
        icon: Rocket,
        color: "text-green-600",
      },
      {
        title: "Apoio à Qualidade",
        description: "Participação na aplicação de padrões como a ISO 9001.",
        icon: Shield,
        color: "text-blue-600",
      },
    ],
  ...
  },
  {
    ...
    period: "2022 - 2025",
    type: "education",
    description: "Curso superior concluído em 2025.",
    achievements: [],
    technologies: [],
    highlights: [],
  ...
  },
  {
    ...
    achievements: [
      ...
      {
        title: "Cliente satisfação 100%",
        description: "Feedback positivo consistente",
        icon: Star,
        color: "text-yellow-600",
      },
    ],
    technologies: ["HTML", "CSS", "JavaScript", "MySQL", "WordPress"],
    highlights: [
